...
dhsclusters_2010 = readRDS(here("RP-Malcomb", "data", "raw", "private", "datasets", "MWGE62FL.rds")) %>%
  as("sf") %>% 
...
dhshh_2010 = readRDS(here("RP-Malcomb", "data", "raw", "private", "datasets", "MWHR61SV.rds")) %>% zap_labels() 
```
...
ggsave(
  here("results","maps","ac_2010_New.png"),
  plot = map_2010,
  width = 8.5,
  height = 11,
  units = "in"
...
ggsave(
  here("results","maps","vulnerability_new.png"),
  plot = vuln_map,
  width = 8.5,
  height = 11,
  units = "in"
